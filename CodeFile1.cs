...
namespace testing
{
    ...
    class Car
    {
        ...
        Derived classes are children and base class is parent, use : for inheritance. Use sealed keyword if we don't want other classes to inherit from a class. 
        ...
        A partial class is a special feature of C#. It provides a special ability to implement the functionality of a single class into multiple files and all these files are combined into a single 
